...
export function Topbar() {
  ...
  return (
    <header className="relative bg-transparent px-4 pt-4 md:hidden">
      ...
      {isOpen ? (
        <div className="mt-4 flex max-h-[calc(100vh-5rem)] flex-col rounded-xl border border-black/[0.06] bg-white p-4 shadow-[0_1px_2px_rgba(0,0,0,0.05)] md:hidden">
          ...
          {data ? (
            <div className="mt-auto border-t border-slate-200 pt-4">
              <UserIdentity user={data} onLogout={handleLogout} dropdownSide="top" />
            </div>
          ) : null}
        </div>
      ) : null}
