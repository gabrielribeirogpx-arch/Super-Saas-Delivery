    ...
    <div className="storefront-page min-h-screen" style={rootStyle}>
      ...
      {enableCart && (
        <div
          id="checkoutModal"
          style={{ display: "none" }}
          className="fixed inset-0 z-[10001] overflow-y-auto bg-slate-950/60 p-3 sm:p-4"
          onClick={(event) => {
        ...
        >
          <div className="flex min-h-full w-full items-center justify-center">
            <div className="flex w-full max-w-xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl max-h-[calc(100dvh-1.5rem)] sm:max-h-[calc(100dvh-2rem)]">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <p className="text-sm text-slate-600">
                      Step <strong>{checkoutFormStep}</strong> of <strong>4</strong>
                    </p>
                    <div className="h-1.5 w-full rounded-full bg-slate-100">
                      <div className="h-full rounded-full bg-slate-300 transition-all duration-300" style={{ width: `${(checkoutFormStep / 4) * 100}%` }} />
                    </div>
                  </div>
            ...
            <footer className="mt-auto space-y-3 border-t border-slate-200 bg-white p-4">
