...
from app.routers.admin_store import router as admin_store_router
...
# Routers
app.include_router(simulator_router, include_in_schema=False)
...
app.include_router(delivery_api_router, include_in_schema=False)
app.include_router(delivery_ws_router, include_in_schema=False)
...
app.include_router(admin_store_router)
...
app.include_router(internal_metrics_router, include_in_schema=False)
app.include_router(internal_test_route_router, include_in_schema=False)
